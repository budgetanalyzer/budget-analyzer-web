...
| Dependency updates, lockfile maintenance, and audit evidence        | [Dependency automation](docs/dependency-automation.md)                                                        |
...
- Read Dependency automation before changing Renovate configuration,
  ...
  npm audit evidence handling, caches, or artifact uploads.

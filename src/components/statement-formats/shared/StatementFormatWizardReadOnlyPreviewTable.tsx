...
interface StatementFormatWizardReadOnlyPreviewTableProps {
...
export function StatementFormatWizardReadOnlyPreviewTable({
  transactions,
}: StatementFormatWizardReadOnlyPreviewTableProps) {
